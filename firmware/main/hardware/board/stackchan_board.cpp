...
#include <hardware/screen_touch/screen_touch.h>
#include "config.h"
...
private:
    ...
    void InitializeAxp2101()
    {
        ...
        pmic_ = new StackChanPmic(i2c_bus_, 0x34);
    }

    void InitializeAw9523()
    {
        ESP_LOGI(TAG, "Init AW9523");
        aw9523_ = new CoreS3IoExpander(i2c_bus_, 0x58);
    ...
    void InitializeFt6336TouchPad()
    {
        ...
        ft6336_ = new StackChanScreenTouch(i2c_bus_, 0x38);
